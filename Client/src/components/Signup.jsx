...
function Signup() {
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      .post("http://localhost:5000/api/v1/users/signup", userInfo,
        {
  ...
  return (  
    <>
      <div className="flex h-screen items-center justify-center">
        <form
          onSubmit={handleSubmit(onSubmit)} // onSubmit is a callback function which is by default given by the react hook form with the data parameter.
          ...
          <label className="input input-bordered flex items-center gap-2">
            ...
            <input
              ...
              {...register("fullname", {
                ...
                minLength: { value: 3, message: "The min length atleast 3" },
                maxLength: { value: 21, message: "The max length atleast 21" },
              })}
            />
          </label>
          {errors.fullname && (
